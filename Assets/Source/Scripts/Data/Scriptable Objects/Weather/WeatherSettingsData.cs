...
{ 
	...
	public class WeatherSettingsData
	{
		...
		[SerializeField] private Color _waterFoamColor;
		...
		[SerializeField] private float _toonMaxLight;
		...
		public Color WaterFoamColor => _waterFoamColor;
		...
		public float ToonMaxLight => _toonMaxLight;
